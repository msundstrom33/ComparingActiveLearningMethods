...
attributes$ALMethod<-as.character(attributes$ALMethod)
attributes$ALMethod[attributes$ALMethod=="PI"]<-"Peer Instruction"
attributes$ALMethod[attributes$ALMethod=="T"]<-"Tutorials"
attributes$ALMethod[attributes$ALMethod=="SU"]<-"SCALE-UP"
attributes$ALMethod<-factor(attributes$ALMethod,levels=c("Peer Instruction","ISLE","Tutorials","SCALE-UP"))
attributes$Discipline<-factor(attributes$Discipline,levels=c("Physics","Astronomy"))

ci_disc<-ggplot() +
  geom_hline(yintercept=0,color = "black")+
  geom_boxplot(data=attributes,aes(x=Discipline, y=as.numeric(HedgesG),ymin = as.numeric(G_LowerCI), ymax = as.numeric(G_UpperCI),alpha=0),width=0.4,outlier.shape=NA,size=0.2,colour="gray40")+
  geom_point(data=attributes,aes(x=Discipline, y=as.numeric(HedgesG),colour=ALMethod),alpha=1,size=2,shape=18,position = position_jitter(
    width = 0.2,
    height = 0
  ))+
  theme_minimal() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.ticks.y = element_line(color = "black", linewidth = 0.5),axis.ticks.x=element_line(color = "black", linewidth = 0.5),axis.title = element_text(size=8,color='black'),axis.text = element_text(size=7,color='black')) + theme(strip.background = element_rect(colour='gray20', linewidth=1),strip.text=element_text(size=7,color='black'))+
  theme(panel.border = element_rect(color = "black", fill = NA, size = 0.5)) + theme(legend.position="none",legend.title=element_blank(),legend.text=element_text(size=7,color='black'))+ylab("Effect Size (Hedges' g)")+xlab("")+scale_x_discrete(labels = function(x) str_wrap(x, width = 10))+ylim(-0.25,3)+scale_color_manual(values=c("#cc79a7","#56b3e9","#e69f00","#009e74"))
...
ci_pub<-ggplot() +
  geom_hline(yintercept=0,color = "black")+
  geom_boxplot(data=attributes,aes(x=PublicPrivate, y=as.numeric(HedgesG),ymin = as.numeric(G_LowerCI), ymax = as.numeric(G_UpperCI),alpha=0),width=0.4,outlier.shape=NA,size=0.2,colour="gray40")+
  geom_point(data=attributes,aes(x=PublicPrivate, y=as.numeric(HedgesG),colour=ALMethod),alpha=1,size=2,shape=18,position = position_jitter(
    width = 0.2,
    height = 0
  ))+
  theme_minimal() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.ticks.y = element_line(color = "black", linewidth = 0.5),axis.ticks.x=element_line(color = "black", linewidth = 0.5),axis.title = element_text(size=8,color='black'),axis.text = element_text(size=7,color='black')) + theme(strip.background = element_rect(colour='gray20', linewidth=1),strip.text=element_text(size=7,color='black'))+
  theme(panel.border = element_rect(color = "black", fill = NA, size = 0.5)) + theme(legend.position="none",legend.title=element_blank(),legend.text=element_text(size=7,color='black'))+ylab("Effect Size (Hedges' g)")+xlab("")+scale_x_discrete(labels = function(x) str_wrap(x, width = 10))+ylim(-0.25,3)+scale_color_manual(values=c("black"))+ theme(axis.title.y = element_blank(), axis.text.y = element_blank(),axis.ticks.y = element_blank())+scale_color_manual(values=c("#cc79a7","#56b3e9","#e69f00","#009e74"))
...
ci_res<-ggplot() +
  geom_hline(yintercept=0,color = "black")+
  geom_boxplot(data=attributes,aes(x=Research, y=as.numeric(HedgesG),ymin = as.numeric(G_LowerCI), ymax = as.numeric(G_UpperCI),alpha=0),width=0.4,outlier.shape=NA,size=0.2,colour="gray40")+
  geom_point(data=attributes,aes(x=Research, y=as.numeric(HedgesG),colour=ALMethod),alpha=1,size=2,shape=18,position = position_jitter(
    width = 0.2,
    height = 0
  ))+
  theme_minimal() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.ticks.y = element_line(color = "black", linewidth = 0.5),axis.ticks.x=element_line(color = "black", linewidth = 0.5),axis.title = element_text(size=8,color='black'),axis.text = element_text(size=7,color='black')) + theme(strip.background = element_rect(colour='gray20', linewidth=1),strip.text=element_text(size=7,color='black'))+
  theme(panel.border = element_rect(color = "black", fill = NA, size = 0.5)) + theme(legend.text=element_text(size=7,color='black'))+ylab("Effect Size (Hedges' g)")+xlab("Institution")+scale_x_discrete(labels = function(x) str_wrap(x, width = 10))+ylim(-0.25,3)+scale_color_manual(values=c("black"))+theme(axis.title.y = element_blank(), axis.text.y = element_blank(),axis.ticks.y = element_blank(),axis.title.x = element_blank())+scale_color_manual(values=c("#cc79a7","#56b3e9","#e69f00","#009e74"))+ theme(legend.text=element_text(size=7,color='black'))+ylab("Effect Size (Hedges' g)")+xlab("")+scale_x_discrete(labels = function(x) str_wrap(x, width = 10))+ylim(-0.25,3)+scale_color_manual(values=c("black"))+ theme(axis.title.y = element_blank(), axis.text.y = element_blank(),axis.ticks.y = element_blank())+scale_color_manual(values=c("#cc79a7","#56b3e9","#e69f00","#009e74"))+theme(legend.position = c(0.65, 0.88),legend.title = element_blank(),
legend.text = element_text(size = 6, color = "black"),
legend.box.background = element_rect(colour = "black", fill = "white",size=0.3),
...
legend.spacing.y = unit(0.1, "cm"))+ guides(alpha = "none")


ci_res


attributes$AlgOrCalcBased<-as.character(attributes$AlgOrCalcBased)
attributes$AlgOrCalcBased[attributes$AlgOrCalcBased=="Algebra"]<-"Algebra-\nbased"
attributes$AlgOrCalcBased[attributes$AlgOrCalcBased=="Calculus"]<-"Calculus-\nbased"

attributes$AlgOrCalcBased<-as.factor(attributes$AlgOrCalcBased)

ci_alg<-ggplot() +
  geom_hline(yintercept=0,color = "black")+
  geom_boxplot(data=attributes,aes(x=AlgOrCalcBased, y=as.numeric(HedgesG),ymin = as.numeric(G_LowerCI), ymax = as.numeric(G_UpperCI),alpha=0),width=0.4,outlier.shape=NA,size=0.2,colour="gray40")+
  geom_point(data=attributes,aes(x=AlgOrCalcBased, y=as.numeric(HedgesG),colour=ALMethod),alpha=1,size=2,shape=18,position = position_jitter(
    width = 0.2,
    height = 0
  ))+
  theme_minimal() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.ticks.y = element_line(color = "black", linewidth = 0.5),axis.ticks.x=element_line(color = "black", linewidth = 0.5),axis.title = element_text(size=8,color='black'),axis.text = element_text(size=7,color='black')) + theme(strip.background = element_rect(colour='gray20', linewidth=1),strip.text=element_text(size=7,color='black'))+
...
combined_plot <- (ci_disc | ci_alg |  ci_pub  | ci_res)

combined_plot_output<-combined_plot +
  plot_annotation(
    theme = theme(
...
ggsave(combined_plot_output,filename = "CI_Factors.pdf",width=6,height=3,units="in",device = cairo_pdf)
